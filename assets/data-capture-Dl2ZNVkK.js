import{k as y,i as $,j as l,O as m,R as p,C as f,S as h,D as E,F as C}from"./ConstantsUtil-BYoA7e9Y.js";import{n as S,c as x,r as u,U as D}from"./index-BoacgqvY.js";import{W as R}from"./index-CxPo_D8H.js";import{ReownAuthentication as v}from"./features-8c_obMNq.js";import"./formatUnits-D9YWQa9u.js";import"./index-BNQGmZwL.js";import"./index-D3tUvDMJ.js";import"./index-CnL311vU.js";const _=y`
  .email-sufixes {
    display: flex;
    flex-direction: row;
...
`;var O=function(r,t,i,a){var n=arguments.length,e=n<3?t:a===null?a=Object.getOwnPropertyDescriptor(t,i):a,o;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")e=Reflect.decorate(r,t,i,a);else for(var s=r.length-1;s>=0;s--)(o=r[s])&&(e=(n<3?o(e):n>3?o(t,i,e):o(t,i))||e);return n>3&&e&&Object.defineProperty(t,i,e),e};const j=["@gmail.com","@outlook.com","@yahoo.com","@hotmail.com","@aol.com","@icloud.com","@zoho.com"];let g=class extends ${constructor(){super(...arguments),this.email=""}render(){const t=j.filter(this.filter.bind(this)).map(this.item.bind(this));return t.length===0?null:l`<div class="email-sufixes">${t}</div>`}filter(t){if(!this.email)return!1;const i=this.email.split("@");if(i.length<2)return!0;const a=i.pop();return t.includes(a)&&t!==`@${a}`}item(t){return l`<wui-button variant="neutral" size="sm" @click=${()=>{const a=this.email.split("@");a.length>1&&a.pop();const n=a[0]+t;this.dispatchEvent(new CustomEvent("change",{detail:n,bubbles:!0,composed:!0}))}}
      >${t}</wui-button
    >`}};g.styles=[_];O([S()],g.prototype,"email",void 0);g=O([x("w3m-email-suffixes-widget")],g);const I=y`
  .recent-emails {
    display: flex;
