import{k as H,i as g,M as W,O as K,j as c,t as _,T as j,J as G,f as E,r as U,h as Y,c as N,C as m,K as V,n as C,W as h,l as L,L as q,P as v,b as k,E as O,S as X,R as J}from"./ConstantsUtil-CHvl1k6B.js";import{r as d,c as w,n as l}from"./index-D8qF7N1v.js";import"./index-DXB-Sudw.js";import{C as z}from"./formatUnits-D9YWQa9u.js";import{e as Q,n as Z}from"./ref-GN89IHZY.js";import"./index-BQesp6dP.js";import{H as I}from"./HelpersUtil-CwNAzLTn.js";import{o as ee}from"./if-defined-DMkFTxsN.js";import"./index-DB1P_glQ.js";import"./index-DAvDS5BK.js";import"./index-FC361KxZ.js";import"./index-DPG_dGIy.js";import"./index-DgdIFc7r.js";import{N as te}from"./NavigationUtil-DmfK5sOV.js";import"./index-QDjzw1ki.js";import"./ConstantsUtil-COJBkkkj.js";const ie=H`
  div {
    width: 100%;
  }
...
`;var x=function(e,t,i,r){var n=arguments.length,o=n<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,i):r,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")o=Reflect.decorate(e,t,i,r);else for(var a=e.length-1;a>=0;a--)(s=e[a])&&(o=(n<3?s(o):n>3?s(t,i,o):s(t,i))||o);return n>3&&o&&Object.defineProperty(t,i,o),o};let p=class extends g{constructor(){super(),this.formRef=Q(),this.usubscribe=[],this.name="",this.error="",this.loading=v.state.loading,this.suggestions=v.state.suggestions,this.profileName=m.getAccountData()?.profileName,this.onDebouncedNameInputChange=k.debounce(t=>{t.length<4?this.error="Name must be at least 4 characters long":I.isValidReownName(t)?(this.error="",v.getSuggestions(t)):this.error="The value is not a valid username"}),this.usubscribe.push(v.subscribe(t=>{this.suggestions=t.suggestions,this.loading=t.loading}),m.subscribeChainProp("accountState",t=>{this.profileName=t?.profileName,t?.profileName&&(this.error="You already own a name")}))}firstUpdated(){this.formRef.value?.addEventListener("keydown",this.onEnterKey.bind(this))}disconnectedCallback(){super.disconnectedCallback(),this.usubscribe.forEach(t=>t()),this.formRef.value?.removeEventListener("keydown",this.onEnterKey.bind(this))}render(){return c`
      <wui-flex
