...
`;var u=function(t,e,i,r){var n=arguments.length,l=n<3?e:r===null?r=Object.getOwnPropertyDescriptor(e,i):r,a;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")l=Reflect.decorate(t,e,i,r);else for(var h=t.length-1;h>=0;h--)(a=t[h])&&(l=(n<3?a(l):n>3?a(e,i,l):a(e,i))||l);return n>3&&l&&Object.defineProperty(e,i,l),l};let g=class extends x{render(){return this.style.cssText=`
      ...
      width: ${this.width};
    `,E`<slot></slot>`}};g.styles=[y,z];u([c()],g.prototype,"flexDirection",void 0);u([c()],g.prototype,"flexWrap",void 0);u([c()],g.prototype,"flexBasis",void 0);u([c()],g.prototype,"flexGrow",void 0);u([c()],g.prototype,"flexShrink",void 0);u([c()],g.prototype,"alignItems",void 0);u([c()],g.prototype,"justifyContent",void 0);u([c()],g.prototype,"columnGap",void 0);u([c()],g.prototype,"rowGap",void 0);u([c()],g.prototype,"gap",void 0);u([c()],g.prototype,"padding",void 0);u([c()],g.prototype,"margin",void 0);u([c()],g.prototype,"width",void 0);g=u([P("wui-flex")],g);const M=Symbol.for(""),U=t=>{if(t?.r===M)return t?._$litStatic$},j=t=>({_$litStatic$:t,r:M}),b=new Map,F=t=>(e,...i)=>{const r=i.length;let n,l;const a=[],h=[];let p,d=0,m=!1;for(;d<r;){for(p=e[d];d<r&&(l=i[d],(n=U(l))!==void 0);)p+=n+e[++d],m=!0;d!==r&&h.push(l),a.push(p),d++}if(d===r&&a.push(e[r]),m){const V=a.join("$$lit$$");(e=b.get(V))===void 0&&(a.raw=a,b.set(V,e=a)),i=h}return t(e,...i)},H=F(E),G=s`<svg width="30" height="30" viewBox="0 0 30 30" fill="none">
...
</svg>`,g1=s`<svg fill="none" viewBox="0 0 16 16">
  <path
    fill="currentColor"
