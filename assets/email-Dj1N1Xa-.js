import{C as S,l as g,O as h,E as c,M as _,R as s,S as f,b as C,f as D,i as b,t as m,j as u,k as $,G as W}from"./ConstantsUtil-Da4cT1ZV.js";import{c as d,r as E}from"./index-Cz5rVThO.js";import{W as y}from"./index-CkkU0KIh.js";import"./index-DgsTSIDt.js";import"./index-Dx5c8ztr.js";import{e as P,n as N}from"./ref-q_BJT-JE.js";import"./index-CjHn1gsG.js";import"./index-DXIDhAWi.js";import{C as T}from"./formatUnits-D9YWQa9u.js";import"./index-Bn9NAJuj.js";import"./index-BwgXIfJB.js";import"./if-defined-CyyHSP7h.js";import"./index-8qqbY_pN.js";var j=function(a,e,t,r){var n=arguments.length,i=n<3?e:r===null?r=Object.getOwnPropertyDescriptor(e,t):r,o;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(a,e,t,r);else for(var l=a.length-1;l>=0;l--)(o=a[l])&&(i=(n<3?o(i):n>3?o(e,t,i):o(e,t))||i);return n>3&&i&&Object.defineProperty(e,t,i),i};let I=class extends y{constructor(){super(...arguments),this.onOtpSubmit=async e=>{try{if(this.authConnector){const t=S.state.activeChain,r=g.getConnections(t),n=h.state.remoteFeatures?.multiWallet,i=r.length>0;if(await this.authConnector.provider.connectOtp({otp:e}),c.sendEvent({type:"track",event:"EMAIL_VERIFICATION_CODE_PASS"}),t)await g.connectExternal(this.authConnector,t);else throw new Error("Active chain is not set on ChainController");if(h.state.remoteFeatures?.emailCapture)return;if(h.state.siwx){_.close();return}if(i&&n){s.replace("ProfileWallets"),f.showSuccess("New Wallet Added");return}_.close()}}catch(t){throw c.sendEvent({type:"track",event:"EMAIL_VERIFICATION_CODE_FAIL",properties:{message:C.parseError(t)}}),t}},this.onOtpResend=async e=>{this.authConnector&&(await this.authConnector.provider.connectEmail({email:e}),c.sendEvent({type:"track",event:"EMAIL_VERIFICATION_CODE_SENT"}))}}};I=j([d("w3m-email-verify-otp-view")],I);const F=D`
  wui-icon-box {
